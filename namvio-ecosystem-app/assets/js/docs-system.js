...
(function () {
    ...
    function scanMotion(root) {
        if (window.NamvioMotion) window.NamvioMotion.scanReveal(root || document);
    }
...
<div class="col-6 col-md-3">
  <div class="lg-kpi-card lg-kpi-card--demo"><span class="lg-kpi-value lg-kpi-value--sm">Demo</span><span class="lg-kpi-label">Illustrative only</span></div>
    ...
    function initLegal() {
        ...
        if (window.NamvioMotion) {
            window.NamvioMotion.scanReveal(root);
            window.NamvioMotion.staggerChildren(document.getElementById('lg-kpi-row'), ':scope > [class*="col-"]');
        }
        scanMotion(root);
    }
    ...
    function initGuide() {
        ...
        if (window.NamvioMotion) window.NamvioMotion.scanReveal(root);
        scanMotion(root);
    }
